# Superb, simple implementation from https://pylessons.com/CartPole-PER/
...
class PER(object):  # stored as ( state, action, reward, next_state ) in SumTree
    ...
    def batch_update(self, tree_idx, abs_errors):
        abs_errors = np.abs(abs_errors) # make sure, impossible to break
...
# Usage Demo - Easy to see lower TD error indexes will be summoned less often
# TODO tomorrow, use this to get array indices, pull from normal replay buffer.
# See if difference made!
#
# memory_size = 5
